	...
	Added Versatile screenshot.png, fixed some issues in functions.php, updated the version number in the style.css file.
	...
	Added footer login/out support.  Fixed some issues related with the 1.2.
	...
	Wordpress 3.2 released today revealing a new admin interface.  All admin styling has been removed via functions.php.  Also, removed code from line 67 	that kept the Featured Image from working with NextGenGallery images.
	
	7/7/2011 DN
	
	- - - - - - - - - - - - - - - - - - - - - - -
	
	I've plugged in some admin editing functionality.
